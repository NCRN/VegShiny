...
#### empty graph panel note ####
output$GraphValidationNote <- shiny::renderUI({
  if (is.null(input$densPark) || !base::nzchar(input$densPark)) {
    htmltools::div(class = "shiny-output-error-validation", "Select a park to display the graph.")
  } else {htmltools::HTML("")
  }})

...
shiny::tabPanel(
  ...
  shiny::fluidRow(
    ...
    # Main Panel
    shiny::column(9, shiny::tabsetPanel(id="tsPanel", type="pills",
                                        ...
                                        # About tab
                                        shiny::tabPanel(title=htmltools::tags$div(title="Explanation of the graph", "About this graph..."), htmltools::includeHTML("www/AboutTS.html"))
